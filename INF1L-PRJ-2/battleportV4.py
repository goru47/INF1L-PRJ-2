...
class Menu(States):
    ...
    def get_event(self, event):
        ...
        if event.type == pg.MOUSEBUTTONDOWN:
            ...
            if 20 + 200 > mouse[0] > 20 and 650 + 100 > mouse[1] > 650:
                self.done = True
    ...
    def draw(self, screen):
        ...
        self.button(startb2, startb, 20, 650, 200, 100)
        self.button(scoreb2, scoreb, 768, 500, 200, 100)
...
class Game(States):
    ...
    def draw(self, screen):
        screen.fill(BLACK)
        screen.blit(menu2b, (0, 0))

        self.button(helpb2, helpb, 824, 668, 120, 70)
